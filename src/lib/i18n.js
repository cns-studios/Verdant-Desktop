const translations = {
  en: {
    ...
    "settings.app.general": "General Behavior",
    "settings.app.notifications_title": "Notifications",
    "settings.app.updates_title": "Updates",
    "settings.app.data_title": "Data Management",
    "settings.app.auto_check": "Check for updates on startup",
    "settings.app.auto_download": "Download updates automatically",
    "settings.app.run_in_background": "Run in background",
    "settings.app.autostart": "Start on login",
    "settings.app.show_notifications": "Show notifications for new emails",
  ...
  de: {
    ...
    "settings.app.channel.nightly": "Nightly (Beta)",
    "settings.app.general": "Allgemeines Verhalten",
    "settings.app.notifications_title": "Benachrichtigungen",
    "settings.app.updates_title": "Aktualisierungen",
    "settings.app.data_title": "Datenverwaltung",
    "settings.app.auto_check": "Beim Start auf Updates prüfen",
    "settings.app.auto_download": "Updates automatisch herunterladen",
    "settings.app.run_in_background": "Im Hintergrund ausführen",
    "settings.app.autostart": "Beim Login starten",
    "settings.app.show_notifications": "Benachrichtigungen für neue E-Mails zeigen",
